        ...
        return (
            <div>
                <InspectorControls>
                    ...
                    >
                        ...
                        <PanelColorSettings
                            ...
                            colorSettings={ [
                                {
                                    value: attributes.mainTitleColor,
                                    onChange: ( value ) => {
                                        return setAttributes( { mainTitleColor: value } );
                                    },
                                    label: __( 'Main title color', 'kenzap-features' ),
                                },
                                {
                ...
                <div className={ className ? className : '' }>
                    <ContainerEdit
                        className={ `kenzap-featured-list-2 block-${ attributes.blockUniqId } ${ isSelected ? 'selected' : '' } ` }
